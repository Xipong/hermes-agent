...
import type { PairingResponse, PairingUser } from '@/lib/api-types'
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        ...
        {approved.length === 0 && (
          <Card>
            <CardContent className="py-8 text-center text-sm text-muted-foreground">No approved users</CardContent>
          </Card>
        )}
