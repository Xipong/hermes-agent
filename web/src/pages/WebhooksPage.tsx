...
import type { WebhookRoute, WebhooksResponse } from '@/lib/api-types'
  ...
  const handleToggleEnabled = useCallback(
    async (subName: string, nextEnabled: boolean) => {
      ...
      try {
        ...
        showToast(nextEnabled ? `Enabled: "${subName}"` : `Disabled: "${subName}"`, 'success')
        loadWebhooks()
      } catch (e) {
    ...
    <div className="flex flex-col gap-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-muted-foreground">
                  Webhooks are their own gateway platform. Enable them here to accept incoming HTTP events; chat
                  channels are only needed when a subscription delivers to Telegram, Discord, Slack, or another channel.
                </span>
              </div>
            </div>
            <Button
      ...
      <div className="flex flex-col gap-3">
        ...
        <p className="text-xs text-muted-foreground -mt-1">
          Subscription changes hot-reload once the webhook receiver is running. Disabled subscriptions reject incoming
          events.
        </p>
