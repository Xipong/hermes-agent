                    ...
                    {!p.status.logged_in && (
                      <>
                        ...
                        <div className="flex min-w-0 flex-wrap items-center gap-2">
                          <code className="font-courier truncate text-xs opacity-60">{p.cli_command}</code>

                          <CopyButton text={p.cli_command} label={t.oauth.cli} copiedLabel={t.oauth.copied} />
                        </div>
                      </>
                    )}
                    {p.status.error && <span className="text-xs text-destructive">{p.status.error}</span>}
                  </div>
                </div>
