...
def test_cli_add_configure_and_runtime_loader_preserve_network_and_sse(monkeypatch, home):
    ...
    from tools.mcp_tool_config import _load_server_configs
    loaded = _load_server_configs()["unity"]
...
def test_portable_env_url_can_be_saved_but_runtime_validates_resolved_target(monkeypatch, home):
    ...
    cfg = _load_server_configs()["portable"]
...
def test_catalog_install_action_forwards_network_and_owner(monkeypatch, client):
