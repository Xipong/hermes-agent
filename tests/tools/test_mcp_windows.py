...
@pytest.mark.asyncio
async def test_native_powershell_bridge_carries_binary_bytes_and_exits_on_stdin_eof():
    import socketserver
    ...
    with socketserver.ThreadingTCPServer(("127.0.0.1", 0), Echo) as server:
        ...
        process = await asyncio.create_subprocess_exec(
            *mcp_windows._windows_tunnel_command("127.0.0.1", server.server_address[1]),
