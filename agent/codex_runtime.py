        ...
        try:
            try:
                ...
                final = _consume_codex_event_stream(
                    ...
                    on_reasoning_delta=_live(agent._fire_reasoning_delta),
                    on_reasoning_event=(
                        _live(agent._fire_reasoning_event)
                        if callable(getattr(agent, "reasoning_event_callback", None)) else None
                    ),
